<html>
<head>
<title>Phitherek_' s SMPBNS - MOD: ExtensionEngine - Instalacja</title>
...
if($_POST['eeset'] == 1) {
	...
	echo("OSTRZEŻENIE: Modyfikacja ExtensionEngine może sprawić, że SMPBNS będzie się ładował bardzo powoli! W zamian ułatwia ona dodawanie rozszerzeń do SMPBNS. Więcej informacji w wiki projektu.<br /><br /> Aby kontynuować, podaj hasło, które jest w pliku informacyjnym dołączonym do systemu: <br />");
?>
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
